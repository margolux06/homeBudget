...
INSERT INTO `one_time_transaction` (`id`, `name`, `value`, `cost_direction`, `pay_date`, `bank_account_id`, `is_active`) VALUES
(RANDOM_UUID(), 'Taras', 5000, 'OUTGOING', NOW(), 2, true );
INSERT INTO `one_time_transaction` (`id`, `name`, `value`, `cost_direction`, `pay_date`, `bank_account_id`, `is_active`) VALUES
(RANDOM_UUID(), 'Markiza', 7500, 'OUTGOING', NOW(), 1, true );
INSERT INTO `one_time_transaction` (`id`, `name`, `value`, `cost_direction`, `pay_date`, `bank_account_id`, `is_active`) VALUES
(RANDOM_UUID(), 'Szkolenia', 8000, 'INCOMING', NOW(), 2, true );
INSERT INTO `one_time_transaction` (`id`, `name`, `value`, `cost_direction`, `pay_date`, `bank_account_id`, `is_active`) VALUES
(RANDOM_UUID(), 'Bonus', 2500, 'INCOMING', NOW(), 1, true );


INSERT INTO `cyclic_transaction` (`id`, `name`, `value`, `cost_direction`, `first_pay_date`, `last_pay_date`, `bank_account_id`, `is_active`, `period`) VALUES
(RANDOM_UUID(), 'Prąd', 110.25, 'OUTGOING', NOW(), NOW(), 2, true, 'PER_MONTH' );
INSERT INTO `cyclic_transaction` (`id`, `name`, `value`, `cost_direction`, `first_pay_date`, `last_pay_date`, `bank_account_id`, `is_active`, `period`) VALUES
(RANDOM_UUID(), 'Gaz', 256.25, 'INCOMING', NOW(), NOW(), 1, true, 'PER_MONTH');
INSERT INTO `cyclic_transaction` (`id`, `name`, `value`, `cost_direction`, `first_pay_date`, `last_pay_date`, `bank_account_id`, `is_active`, `period`) VALUES
(RANDOM_UUID(), 'Woda', 450.89, 'INCOMING', NOW(), NOW(), 2, true, 'PER_THREE_MONTHS' );